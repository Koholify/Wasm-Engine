...
#define kc_arr_setcap(t, n) (kc_arr_grow((void*)t, sizeof(*t), (int)n))
#define kc_arr_setlen(t, n) ((n < kc_arr_len(t) ? \
		kc_arr_canadd(t, n - kc_arr_len(t)) : 0), kc_arr_header(t)->length = n)
